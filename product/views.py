...
from product.models import Product, ProductAlbum, Media, ProductSale, Sale
...
class ProductView(generics.GenericAPIView):
    ...
    def post(self, request):
       ...
       # price = serializer.validated_data.get['price'] 
        ...
        # for img in images:
            #    Media.objects.create(file=img, type="IMAGE", album=album)
            Media.objects.bulk_create([Media(file=img, type="IMAGE", album=album) for img in images])
